package com.example.asus_pc.peliculas.Perfil.view;
...
public class PerfilFragment extends Fragment implements PerfilFragmentView{
    ...
    public void initSharedPreferences(){
        sharedPreferences = this.getActivity().getSharedPreferences("PreferencesPelicula", Context.MODE_PRIVATE);
